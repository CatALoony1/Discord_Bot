                    ...
                    if (activeItem.endTime < new Date()) {
                                ...
                                await getTenorGifById("20062805")
                                    .then(async (gifUrl) => {
                                        ...
                                        await targetChannel.send({
                                            content: `Bei <@${activeItem.usedOn}> ist eine Bombe explodiert! **${amount}** Monde sind verpufft!`,
                                            files: [gifUrl]
                                        });
                                    })
                                    .catch((error) => {
                        ...
                        if (activeItem.extras != new Date().toLocaleDateString()) {
                            ...
                            if (userObj && usedOnObj) {
                                ...
                                await targetChannel.send(`Von <@${activeItem.usedOn}> wurden 500 Monde Schulden an <@${activeItem.user}> übergeben.`);
                            }
                        }
                    }
                }
