...
const createSpieleLeaderboardEmbeds = require('../createSpieleLeaderboardEmbeds');

async function spieleLeaderboardPage(interaction) {
...
module.exports = spieleLeaderboardPage;
