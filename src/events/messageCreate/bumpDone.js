    ...
    if (message.embeds[0] != null && message.embeds[0].description.includes("Bump erfolgreich")) {
      ...
      if (level) {
        ...
        const embed = new EmbedBuilder()
          ...
          .setDescription(`Danke <@${userid}>, dass du den Server gebumpt hast. Um unsere Dankbarkeit zu zeigen bekommst du für 24 Stunden die Rolle **Bumper**, durch diese Rolle erhälst du einen Bonus von 10% auf jegliche erhaltene Erfahrung und 15% auf jegliche GELD!`)
