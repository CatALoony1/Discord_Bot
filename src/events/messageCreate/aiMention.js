...
module.exports = async (message) => {
    ...
    try {
        ...
        let sysInstruction = `Dein Name ist Yamcha und du befindest dich auf einem Discord Server namens 'LEAFing Reality'. Da Discord eine Zeichengrenze bei Nachrichten hat, antwortest du mit unter 1500 Zeichen.`;
