...
module.exports = async (interaction) => {
    if (!interaction.isButton() || !interaction.customId || !interaction.customId.includes('spieleLeader')) return;
        ...
        try {
            if (page != 1) {
                ...
                await interaction.update({
                    embeds: [await createSpieleLeaderboardEmbeds(newPage - 2, interaction)],
